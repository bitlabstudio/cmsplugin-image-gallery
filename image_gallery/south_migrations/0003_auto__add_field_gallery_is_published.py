...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.is_published'
        db.add_column('image_gallery_gallery', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.is_published'
        db.delete_column('image_gallery_gallery', 'is_published')
